...
$(document).ready(function () {
    $('.razorpay-btn').click(function (e) { 
        ...
        if (fname_error != '' || lname_error != '' || address1_error != '' || city_error != '' || state_error != '' || pincode_error != '' || phone_error !=  '' ||  email_error != '' ) 
        {
            return false;   
        }
        else
            ...
            $.ajax({
                ...
                success: function (response) {
                     //alert(response.total_price);
                            ...
                            var options = {
                                "key": "rzp_test_nj5IK7huuHpCDj", // Enter the Key ID generated from the Dashboard
